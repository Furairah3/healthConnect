        ...
        <div class="container">
            <div class="row align-items-center">
                    ...
                    <div class="welcome-message">
                        ...
                        <div class="volunteer-info-card mt-4">
                            <div class="info-item">
                                ...
                                <span><strong>Profession:</strong> <?php echo htmlspecialchars($profession); ?></span>
                            </div>
                            <div class="info-item">
                            ...
                            <div class="info-item">
                                ...
                                <span><strong>Email:</strong> <?php echo htmlspecialchars($volunteer_details['email_address'] ?? ''); ?></span>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 text-end">
                    <div class="mb-4">
                        <span class="volunteer-badge me-3">
                            <i class="fas fa-hands-helping me-1"></i> Healthcare Volunteer
                        </span>
                        <a href="profile.php" class="btn btn-outline-light btn-lg px-4">
